...
def plotHistograms(df, feature_list,nrows, ncols, figsize=(20,10), category = 'categories', group_1 = 'Inactive', group_2 = 'Active'):
    ...
    for feature in feature_list:
        ...
        plt.hist(df[df[category]==group_1][feature])
        plt.hist(df[df[category]==group_2][feature],alpha=0.8)
        plt.xlabel(feature)
        count += 1
