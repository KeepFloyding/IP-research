-- Find users that are students and are affiliated with any teachers
-- and find all of their clickstream data
WITH select_users AS
(
    SELECT user_id_granting_permission AS id, user_id_receiving_permission AS teacher_id, school_id
